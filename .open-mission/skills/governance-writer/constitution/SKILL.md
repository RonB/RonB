...
## Neighboring Governance Domains
...
When the topic is an Entity, use `entity-specification` to inspect the Entity class, schema, contract, documentation, and consumers before writing. Keep Entity pages under `.open-mission/knowledgebase/entities/` and cross-reference contracts or decisions only when the Entity changes boundary behavior or governance.

## Primary Resources

- `.open-mission/knowledgebase/constitution/index.md`
- `.open-mission/knowledgebase/constitution/engineering-principles.md`
