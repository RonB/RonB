...
1. Inspect whether the repository governance tree exists and whether it is scaffolded:
   ...
   - `.open-mission/knowledgebase/index.md`
...
- Entity pages go under `.open-mission/knowledgebase/entities/`.
- Entity exchange contracts go under `.open-mission/knowledgebase/contracts/` only when the contract is reusable across a boundary.
- Entity decisions go under `.open-mission/knowledgebase/decisions/` only when the change alters ownership, naming, lifecycle, public contract, persistence, or boundary behavior.

## Authority Ladder

Lower authority may explain higher authority, but it must not override it.

1. `.open-mission/knowledgebase/product/context.md`, constitution pages, accepted decisions, and explicit repository governance under `.open-mission/knowledgebase/`
...
For this repository, the canonical repository governance tree is `.open-mission/knowledgebase/`.

- treat `.open-mission/knowledgebase/` as the source tree for repository-owned governance
- use the governance domain tree exactly as scaffolded there
- treat `.open-mission/knowledgebase/decisions/` as the home for decisions, not a separate ADR tree
- treat `.open-mission/knowledgebase/product/context.md` as the canonical vocabulary and relationship map
...
- `.open-mission/knowledgebase/product/context.md`
- `.open-mission/knowledgebase/`
...
- explain what the thing is, why it exists, what it owns, and which neighboring owner carries adjacent responsibilities
