...
- `.open-mission/knowledgebase/product/index.md`
- `.open-mission/knowledgebase/product/purpose.md`
- `.open-mission/knowledgebase/product/scope.md`
- `.open-mission/knowledgebase/product/users-and-roles.md`
- `.open-mission/knowledgebase/product/capabilities.md`
- `.open-mission/knowledgebase/product/terminology.md`
