...
- `.open-mission/knowledgebase/decisions/index.md`
- `.open-mission/knowledgebase/decisions/ADR-template.md`
- `.open-mission/knowledgebase/decisions/` itself
...
Cross-reference the affected Entity page under `.open-mission/knowledgebase/entities/`.
