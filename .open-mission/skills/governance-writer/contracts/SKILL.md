...
- `.open-mission/knowledgebase/contracts/index.md`
- `.open-mission/knowledgebase/contracts/`
...
Document the Entity itself under `.open-mission/knowledgebase/entities/`.

Document contract pages under `.open-mission/knowledgebase/contracts/` only when the Entity contract is reused across a boundary or needed independently from the Entity page.
